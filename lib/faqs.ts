...
export const faqs: Faq[] = [
  ...
  },
  {
    ...
    answer:
      "Hay un solo plan de $550 MXN/mes, mes a mes y sin permanencia, con habitaciones ilimitadas y todo incluido: el motor de reservas directo (0% de comisión), el PMS completo, Camila (agente de WhatsApp con IA 24/7), el dashboard con tus reservas y métricas, y el CRM de huéspedes con emails automáticos. Lo pruebas 14 días gratis y sin tarjeta; activas tu plan solo si te convence.",
  },
  {
    question: "¿Necesito tarjeta para empezar?",
    answer:
      "No. Creas tu cuenta, cargas tu hotel y usas Kora completo durante 14 días sin dar ningún dato de pago. Cuando te convenza (o al terminar tu prueba) activas tu plan de $550 MXN/mes. Si no lo activas, tu motor de reservas se pausa, pero tus datos se conservan íntegros y puedes retomarlos cuando quieras.",
  },
  {
