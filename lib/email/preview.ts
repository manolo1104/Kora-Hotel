...
export const GRUPOS: GrupoPreview[] = [
  ...
  },
  {
    ...
    entradas: [
      ...
      {
        id: "seq-registro-previo",
        nombre: "Regístrate antes de llegar (pre check-in)",
        quien: "Huésped",
        cuando: "Cron 15:00 UTC, ventana [check-in −2, check-in). Sólo si el hotel lo encendió y si aún no se registró.",
        origen: "app/api/cron/email-sequences/route.ts",
        bilingue: true,
        render: (lang) => ({
          html: buildRegistroPrevioEmailHtml({
            hotel: HOTEL_SEQ,
            customerName: CLIENTE,
            confirmacion: CONFIRMACION,
            checkin: CHECKIN,
            habitaciones: HABS.join(", "),
            registroUrl: "https://kora-hotel.com/h/hotel-ejemplo/pre-checkin?r=00000000-0000-4000-8000-000000000000",
            checkinHora: "3:00 PM",
            lang,
          }),
        }),
  ...
  },
  {
    ...
    entradas: [
      ...
      {
        id: "anuncio-hotelero",
        nombre: "Novedades · al HOTELERO (cliente)",
        quien: "Hotelero",
        cuando: "NO lo manda ningún cron. Lo dispara una persona con CRON_SECRET; sin ?enviar=1 sólo cuenta a cuántos les llegaría. Botón a SU panel y pie de aviso de cuenta, sin baja.",
        origen: "app/api/cron/anuncio/route.ts",
        render: () => emailAnuncio({ nombre: "Luis" }),
      },
      {
        id: "anuncio-suscriptor",
        nombre: "Novedades · al de la LISTA (todavía no es cliente)",
        quien: "Hotelero",
        cuando: "La otra cara del mismo correo: botón a precios y baja de un clic, porque a la lista de captación sí es comercial.",
        origen: "app/api/cron/anuncio/route.ts",
