  ...
  return (
    <section className="py-16 sm:py-20 bg-kora-primary">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <a
          href="/#contacto"
          className="mt-6 inline-flex items-center gap-2 px-6 py-3.5 rounded-full bg-white text-kora-primary font-bold text-sm hover:bg-gray-50 transition-colors"
        >
          Solicitar mi lugar
