...
export function HerramientasExplorador() {
  ...
  // Grupos a renderizar, con sus herramientas filtradas.
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        <div className="mt-4 flex flex-wrap justify-center gap-2" role="group" aria-label="Filtrar por categoría">
          {chips.map((c) => {
